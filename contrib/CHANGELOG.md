...
## 2.1.0 22/09/2026
  ...
  - [NEW] Added `specialization_provider_interface` (no-op: EverQuest II classes are already terminal, no sub-spec layer to seed) (#6)
  - [FIX] Missing `bb_portal_tabs` seed row in the guild-view functional test fixture
  - [FIX] `cleanup.sql`: stale `bbguild_eq2` naming and a wrong column name
