<?php
/**
 * bbGuild EQ2 Extension — extension lifecycle smoke test
 *
...
/**
 * Disables and re-enables bbguildeq2 and asserts the enable/disable HTTP
 ...
 * @group smoke
 */
class avathar_bbguildeq2_smoke_extension_lifecycle_test extends phpbb_functional_test_case
{
	...
	public function test_disable_and_reenable_bbguildeq2()
	{
		$this->assertTrue($this->is_active('avathar/bbguildeq2'), 'bbguildeq2 should already be active from setup_extensions()');

		$this->disable_ext('avathar/bbguildeq2');
		$this->assertFalse($this->is_active('avathar/bbguildeq2'));

		$this->install_ext('avathar/bbguildeq2');
		$this->assertTrue($this->is_active('avathar/bbguildeq2'));
	}
}
